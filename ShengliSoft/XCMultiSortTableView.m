...
//        self.layer.borderColor = [[UIColor colorWithWhite:XCMultiTableView_BoraerColorGray alpha:1.0f] CGColor];
        self.layer.borderColor = [[UIColor colorWithRed:0.3 green:0.3 blue:0.3 alpha:1] CGColor];
        ...
        boldSeperatorLineColor = [UIColor colorWithRed:50/255 green:50/255 blue:50/255 alpha:1.0];
        normalSeperatorLineColor = [UIColor colorWithRed:50/255 green:50/255 blue:50/255 alpha:1.0];
...
//        vertexView.backgroundColor = [UIColor clearColor];
        vertexView.backgroundColor = [UIColor colorWithRed:50/255 green:50/255 blue:50/255 alpha:1];
        ...
        vertextLabel.textColor = [UIColor whiteColor];
        ...
        leftHeaderTableView.separatorColor = [UIColor colorWithRed:0.3 green:0.3 blue:0.3 alpha:1.0];
        leftHeaderTableView.separatorInset = UIEdgeInsetsZero;
        leftHeaderTableView.backgroundColor = [UIColor colorWithRed:100/255 green:100/255 blue:100/255 alpha:1.0];
        ...
        contentScrollView.backgroundColor = [UIColor colorWithRed:0.3 green:0.3 blue:0.3 alpha:1.0];
//        contentScrollView.backgroundColor = [UIColor clearColor];
        ...
        contentTableView.separatorColor = [UIColor colorWithRed:0.3 green:0.3 blue:0.3 alpha:1.0];
        contentTableView.separatorStyle = UITableViewCellSeparatorStyleNone;
//
        contentTableView.backgroundColor = [UIColor colorWithRed:0.3 green:0.3 blue:0.3 alpha:1];
...
//            subView.backgroundColor = [UIColor colorWithRed:200/255 green:200/255 blue:200/255 alpha:1];
//            if (i == 1) {
...
//    view.backgroundColor = [UIColor colorWithRed:50/255 green:50/255 blue:50/255 alpha:1.0];
...
- (UITableViewCell *)contentTableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.backgroundColor = [UIColor colorWithRed:0.3 green:0.3 blue:0.3 alpha:1.0];
    [[cell.contentView subviews] makeObjectsPerformSelector:@selector(removeFromSuperview)];
